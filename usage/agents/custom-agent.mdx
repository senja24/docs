---
title: Custom Assistant Guide
---

As the basic functional unit of Cleek, adding and iterating assistants is very important. Now you can add assistants to your favorites list in two ways.

## `A` Add through the role market

If you are a beginner in Prompt writing, you might want to browse the assistant market of Cleek first. Here, you can find commonly used assistants submitted by others and easily add them to your list with just one click, which is very convenient.

<img alt="Add through the role market" src="https://github-production-user-asset-6210df.s3.amazonaws.com/17870709/279588466-4c32041b-a8e6-4703-ba4a-f91b7800e359.png" />
...
<Cards rows={2}>
  <img alt="Create a custom assistant S3" src="https://github-production-user-asset-6210df.s3.amazonaws.com/17870709/279587294-388d1877-193e-4a50-9fe8-8fbcc3ccefa0.png" />
...
If you want to understand Prompt writing tips and common model parameter settings, you can continue to view:
  ...
  <Card href="/usage/agents/prompt" title="Prompt User Guide" />

  <Card href="/usage/agents/model" title="Large Language Model User Guide" />
